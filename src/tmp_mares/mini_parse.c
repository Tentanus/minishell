...
/*   Updated: 2023/03/03 12:08:42 by mverbrug      ########   odam.nl         */
/*                                                                            */
/* ************************************************************************** */
...
void	mini_parse_input(char *input, t_cmd *cmd)
{
    ...
    cmd->cmd = malloc(ft_strlen(input_split[0]) * sizeof(char));
    ft_strlcpy(cmd->cmd, input_split[0], ft_strlen(input_split[0]) + 1);
